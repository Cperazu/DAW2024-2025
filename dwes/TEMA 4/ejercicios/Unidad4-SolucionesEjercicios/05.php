        ...
        <form action="05result.php" method="post">
          <ol>
            <li>
              ...
              <input type="radio" name="r1" value="2">b) double<br>
            ...
            <li>
                ...
                <input type="radio" name="r5" value="2">a) RAM<br>
