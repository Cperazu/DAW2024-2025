...
function editarDatos(pos) {
    ...
    var datos = parser.parseFromString(atob(token), "application/xml");
    document.getElementById("nombre").value = datos.querySelector("nombre").textContent;
    document.getElementById("fecha").value = datos.querySelector("fechaAlta").textContent;
    document.getElementById("bruto").value = datos.querySelector("bruto").textContent;
    document.getElementById("irpf").value = datos.querySelector("irpf").textContent;
    peticion.pos = pos;
