...
divContainer
  .querySelector("div:first-of-type > form > button:first-of-type")
  .setAttribute("class", "btn-add");
...
const numTasks = body.querySelector(
  "div[class=task-count] span:nth-of-type(2)"
);

//constante del input que nombra la tarea
const nameTaskInput = divContainer.querySelector(
  "div:first-of-type form input"
);
